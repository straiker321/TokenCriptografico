                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-confirmado">
                                <% String fueConfirmado = token.getFueConfirmadoTexto(); %>
                                <% if ("SI (FINAL)".equals(fueConfirmado)) { %>
                                <span class="badge badge-success"><%= fueConfirmado %></span>
                                <% } else if ("SI (INICIAL)".equals(fueConfirmado)) { %>
                                <span class="badge badge-info"><%= fueConfirmado %></span>
                                <% } else { %>
                                <span class="badge badge-warning"><%= fueConfirmado %></span>
                                <% } %>
                            </td>
                            <td class="col-tiene-token">
                                <% String tieneToken = token.getTieneTokenTextoVigente(); %>
                                <% if ("CON TOKEN".equals(tieneToken)) { %>
                                <span class="badge badge-success"><%= tieneToken %></span>
                                <% } else if ("SIN TOKEN".equals(tieneToken)) { %>
                                <span class="badge badge-danger"><%= tieneToken %></span>
                                <% } else { %>
                                <span class="badge badge-neutral"><%= tieneToken %></span>
                                <% } %>
                            </td>
