...
public class TokenDAO {
    ...
    public List<Token> listarParaImplementadorNoAdmin1() {
        List<Token> tokens = new ArrayList<>();
    ...
    public List<Token> listarParaImplementadorNoAdmin2() {
        List<Token> tokens = new ArrayList<>();
    ...
    public boolean actualizarConfirmacionInicial(Token token) {
        String sql = "UPDATE t_m_asigna_token SET "
    ...
    public boolean actualizarConfirmacionFinal(Token token) {
        String sql = "UPDATE t_m_asigna_token SET "
    ...
    private Token mapearTokenBasico(ResultSet rs) throws SQLException {
        ...
        try {
            ...
            if (flgtokcon != null) {
                token.setFlgtokcon(flgtokcon);
            }

            Integer esttokcon = (Integer) rs.getObject("esttokcon");
            if (esttokcon != null) {
                token.setEsttokcon(esttokcon);
            }
        } catch (SQLException e) {
            // Campos opcionales
        }
    ...
    private Token mapearTokenCompleto(ResultSet rs) throws SQLException {
        ...
        try {
            ...
            if (codempcon != null) {
                ...
                if (unienttokcon != null) {
                    token.setUnienttokcon(unienttokcon);
                }
            }
        } catch (SQLException e) {
        }
        ...
        try {
            ...
            if (codempcon2 != null) {
                ...
                if (unienttokcon2 != null) {
                    token.setUnienttokcon2(unienttokcon2);
                }
            }
        } catch (SQLException e) {
        }
